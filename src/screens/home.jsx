    ...
    <div className="w-full h-full bg-white">
      ...
      <main className="w-full h-screen  bg-gradient-to-r from-white to-[#4f4f4f]">
        <div className=" h-full px-20  flex flex-col gap-y-4 justify-center items-center">
          ...
          <div className="sm:w-[50%] flex gap-x-4 items-center">
            ...
            <Button bg="bg-primary" withIcon={true}>
              ...
              <p className="text-white sm:text-xl xl:text-2xl font-[500]">
                See Videos
              </p>
            </Button>
          </div>
      ...
      <section className="w-full bg-white py-6 flex flex-col gap-y-10">
        <div className="w-full flex flex-col items-start">
          <div
            className="w-[80%] border-y border-r border-slate-200 rounded-tr-2xl rounded-br-2xl  px-10
          flex gap-x-4 items-center justify-start"
          >
        ...
        <div className="w-full flex flex-col items-end">
          <div
            className="w-[80%]  border-y border-l border-secondary bg-secondary rounded-tl-2xl rounded-bl-2xl  px-10
          flex gap-x-4 items-center justify-end"
          >
            <img src={Icon} className="w-60 h-60 rounded-xl" alt="" />
      ...
      <section className="w-full bg-white p-8 relative">
        <div className="w-56 h-3 rounded-full bg-gold mx-auto my-4"></div>
